...
<body class="auth-page">
    <main class="auth-container">
        <section class="auth-card card shadow-lg auth-card--entrance">
            <div class="card-body p-4 p-md-5">
                ...
                <nav class="auth-links text-center" aria-label="Enlaces de autenticación">
                    <p class="text-secondary small mb-2">¿Problemas para entrar? Verifica correo y contraseña o crea una cuenta nueva.</p>
                    <p class="mb-2 small">
                        ¿No tienes cuenta?
    ...
    <script src="public/js/api.js?v=1"></script>
    <script src="public/js/validaciones.js?v=2"></script>
    <script src="public/js/autenticacion.js?v=3"></script>
    <script>
