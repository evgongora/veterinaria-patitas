...
<aside class="app-sidebar">
    ...
    <?php endif; ?>
    <a href="index.php?r=citas-pendientes" class="nav-item<?php echo $na('citas-pendientes'); ?>"><i class="bi bi-calendar-check patitas-nav-icon" aria-hidden="true"></i> Confirmar citas</a>
    ...
    <a href="index.php?r=citas" class="nav-item<?php echo $na('citas'); ?>"><i class="bi bi-calendar3 patitas-nav-icon" aria-hidden="true"></i> Listado de citas</a>
